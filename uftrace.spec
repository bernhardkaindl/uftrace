...
%if 0%{?centos} >= 9
         "Skipped")                 test $count -le   64;; # Xen Guest: 64(PMU?), COPR:40
%else
...
%changelog
* Fri Mar 24 2023 Bernhard Kaindl <contact@bernhard.kaindl.dev> 0.13-14
